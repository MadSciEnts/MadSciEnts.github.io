...
Leverage a strong reasoning model (e.g., Grok) to design a detailed, self-contained framework prompt.
Apply that prompt in a fresh IDE session with Gemini for code realization.
